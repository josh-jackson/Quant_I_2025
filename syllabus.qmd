...
When: Class: 9:30 AM - 10:50 Tuesday & Thursday.

Sam office hours: 11-12 Tue & Thursday 407A Somers Ben office hours: 2-3pm on Monday and Tuesday 250 Somers. Josh office hours:

Where: 216 Somers

Who: Josh Jackson and AIs Sam Bennett & Ben Hardin

Why: Literally most important class ever. Plus it is a requirement.

# Weekly schedule

| Week | Date | Topic | Readings | HW Due |
|:-------------:|:-------------:|:-------------:|:-------------:|:-------------:|
| 1 | 8/26 | Models | ST 5 - 5.4; LSR 1-4,7 |  |
| \- | 8/28 | Describing data | LSR 5 |  |
| 2 | 9/2 | GLM basics | LSR 15 - 15.2 |  |
| \- | 9/4 | Probability distributions | LSR 9 |  |
| 3 | 9/9 | Probability distributions |  |  |
| \- | 9/11 | Estimation, Likelihood & Loss | 15.4 - |  |
| 4 | 9/16 | Estimation, Likelihood & Loss |  |  |
| \- | 9/18 | Simple regressions (1 predictor and t-tests) | LSR 13 | HW 1 due |
| 5 | 9/23 | **Exam 1** |  |  |
| \- | 9/25 | Statistical inference part 1 (Sampling and NHST) | LSR 10 & 11 |  |
| 6 | 9/30 | Statistical inference part 1 (Sampling and NHST)  | LSR 15.5 - 15.7 |  |
| \- | 10/2 |  Statistical inference part 2 (Estimation) | LSR 15.10 |  |
| 7 | 10/7 | *No Class - Fall Break!* |  |  |
| \- | 10/9 |Statistical inference part 2 (Estimation)  |  |  |
| 8 | 10/14 | Statistical inference part 3 (Model comparisons) |  |  |
| \- | 10/16 | Statistical inference part 3 (Model comparisons) LSR 15.8 |  ||
| 9 | 10/21 | What can go wrong (Transparency and Open science)  |  | HW 2 due |
| \- | 10/23 | Power || LSR 6 |  |
| 10 | 10/28 | Assumptions  |  |  |
| \- | 10/30 | **Exam 2** |  | HW 3 due |
| 11 | 11/4 | 3 or more means (ANOVA) | LSR 14 |  |
| \- | 11/6 | Multiple comparisons & contrasts |  |  |
| 12 | 11/11 | Interactions | LSR 16 |  |
| \- | 11/13 | ANCOVA |  |  |
| 13 | 11/18 | Within-subjects designs |  | HW 4 due |
| \- | 11/20 | Binomial and logistic regression |  |  |
| 14 | 11/25 | Chi-Square test | LSR 12 |  |
...
This course is the first in a two-course sequence that introduces necessary skills and knowledge for carrying out statistical analyses in the social sciences. The course has an applied focus for psychological research, but theoretical details will be emphasized when they facilitate understanding of key concepts. In other words, we will strike a balance between learning how to do statistics and knowing why we are doing it a particular way. Mastering both will facilitate generalization to new problems and techniques. Topics to be covered this semester include theoretical probability distributions (e.g., binomial, $t$, $F$, $\chi^2$), general linear model(GLM) basics, inferences about population means, confidence intervals, the pros and cons of null hypothesis testing, power, and effect sizes.

### Textbook

-   We will primarily be referring to chapters in [*Learning Statistics with R*](https://learningstatisticswithr.com/book/) by Danielle Navarro. [pdf version](https://learningstatisticswithr.com/lsr-0.6.pdf)

-   Statistical thinking for the 21st century is another good intro book to cover all bases. By Russell A. Poldrack [Statistical thinking for the 21st century](https://statsthinking21.github.io/statsthinking21-core-site/)
...
Homework assignments are intended to gauge your ability to apply the topics covered in class to the practice of data analysis. Homework assignments are to be done using R and Quarto/RMarkdown; completed assignments should be submitted to Canvas. Please submit BOTH your .qmd/.Rmd and an .html file. Please do not use PDF or Word documents. There will be 5 assignments in total, each worth 6% of your grade.

HWs are due at their due date by 12:00am. Grading will go by the following rubric:
...
-   5/6: Completed all parts of the assignment, and \~5-25% of the results/interpretations are incorrect
-   4/6: Completed all parts of the assignment, however \~26-40% of the results/interpretations are incorrect
-   3/6: Either parts of the assignment are missing but what is there is correct, OR all parts have been completed but there are substantial issues with the results/interpretation \>40%
...
-   We will (likely) have a dedicated class Slack work space. You can post questions that everyone can see, or make use of direct messaging. Josh or the AIs will respond to your questions on Slack (if your peers don't respond first!). This is really great for one-off questions, or if you need some quick clarification on something. We will also have a dedicated channel for silly programming and stats memes, because humor is important when you're learning a skill like coding, in which you'll repeatedly fail. Slack is not required *per se*, but it is **highly encouraged**.

## LLMs and our AI overlords

-   Very useful for stats, especially basic stats. Use them! But do not be like me in terms of spellcheck and my subsequent spelling abilities. Have a discussion to understand the material at a deeper level. Do not use them just for efficiency.
...
-   You are adults. Come to class when you can. Let me know when you can't (quick email is OK).
...
-   There will be a lot of online communication with the instructor, the AIs, and your peers. You are expected to maintain a polite and respectful tone in their online discourse. Some things to consider:
